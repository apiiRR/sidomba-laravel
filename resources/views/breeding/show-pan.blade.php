...
<div class="container-fluid">
        ...
        <div class="card-body">
            <form>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="{{$breedingPan->panCategory->category_name}}"
                        readonly>
                </div>
            </form>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
            ...
            @if ($breedingPan->breeding->is_active)
            <a type="button" class="btn btn-success"
                href="{{ route('breeding.inputSheep', ['id' => $breedingPan->breeding_pan_id]) }}">Tambah
                Domba</a>
            @endif
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTableSheep" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($breedingPan->breedingSheep as $key => $value)
                        <tr>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
            ...
            @if ($breedingPan->breeding->is_active)
            <a type="button" class="btn btn-success"
                href="{{ route('breeding.inputSheep', ['id' => $breedingPan->breeding_pan_id]) }}">Tambah Pakan</a>
            @endif
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTableFeed" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($breedingPan->breedingFeeds as $key => $value)
                        <tr>
                            <td>{{ $value->date }}</td>
                            <td>{{ number_format($value->forage_feed) }} gram</td>
                            <td>{{ number_format($value->concentrate_feed) }} gram</td>
